...
--nThreads 1  --customise PhysicsTools/NanoAODJMAR/nano_jmar_cff.JMARnano_customizeMC_noInputs  $NO_EXEC $PARALLEL
...
--nThreads 1  --customise PhysicsTools/NanoAODJMAR/nano_jmar_cff.JMARnano_customizeData_noInputs  $NO_EXEC $PARALLEL
