...
--customise PhysicsTools/PFNano/addAK15_cff.PFnano_addAK15_mc,PhysicsTools/PFNano/pfnano_cff.PFnano_customizeMC$NOINPUTS  $NO_EXEC $PARALLEL
...
--customise PhysicsTools/PFNano/addAK15_cff.PFnano_addAK15_data,PhysicsTools/PFNano/pfnano_cff.PFnano_customizeData$NOINPUTS  $NO_EXEC $PARALLEL
