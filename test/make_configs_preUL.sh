...
--nThreads 1  --customise PhysicsTools/NanoAODJMAR/nano_jmar_cff.JMARnano_customizeMC$NOINPUTS  $NO_EXEC $PARALLEL
...
--nThreads 1  --customise PhysicsTools/NanoAODJMAR/nano_jmar_cff.JMARnano_customizeData$NOINPUTS  $NO_EXEC $PARALLEL
