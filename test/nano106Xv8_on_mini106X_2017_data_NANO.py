...
# with command line options: nano106Xv8_on_mini106X_2017_data --data --eventcontent NANOAODSIM --datatier NANOAODSIM --step NANO --conditions 106X_dataRun2_v32 --era Run2_2017,run2_nanoAOD_106Xv1 --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False))) --nThreads 4 -n 100 --filein /store/data/Run2017B/JetHT/MINIAOD/09Aug2019_UL2017-v1/50000/421E15F6-C6DA-D848-9537-FEC70D67C61C.root --customise PhysicsTools/PFNano/pfnano_cff.PFnano_customizeData
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('nano106Xv8_on_mini106X_2017_data nevts:100'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('nano106Xv8_on_mini106X_2017_data_NANO.root'),
