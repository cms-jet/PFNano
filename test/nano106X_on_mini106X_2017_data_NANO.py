...
from PhysicsTools.NanoAODJMAR.nano_jmar_cff import JMARnano_customizeData, JMARnano_customizeData_allPF, JMARnano_customizeData_AK8JetsOnly

#call to customisation function JMARnano_customizeData imported from PhysicsTools.NanoAODJMAR.nano_jmar_cff
process = JMARnano_customizeData(process)                   #### Only PF cands from AK4 CHS and AK8 PUPPI jets
#process = JMARnano_customizeData_allPF(process)
