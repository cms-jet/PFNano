...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL18MiniAOD/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v11_L1v1-v2/00000/00C0447B-B38D-BA42-941D-F1E2CD1577E0.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('nano106Xv8_on_mini106X_2017_mc_NANO_myTests_WIP.py nevts:5000'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('/nfs/dust/cms/user/anstein/nano106Xv8_on_mini106X_2017_mc_NANO_py_NANO_AddDeepJet.root'),
...
from PhysicsTools.PFNano.pfnano_cff import PFnano_customizeMC, PFnano_customizeMC_allPF, PFnano_customizeMC_AK4JetsOnly, PFnano_customizeMC_AK8JetsOnly, PFnano_customizeMC_noInputs, PFnano_customizeMC_add_DeepJet, PFnano_customizeMC_add_DeepJet_and_Truth, PFnano_customizeMC_allPF_add_DeepJet, PFnano_customizeMC_AK4JetsOnly_add_DeepJet
