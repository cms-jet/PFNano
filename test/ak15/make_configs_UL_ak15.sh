...
--customise PhysicsTools/PFNanoAK15/addAK15_cff.setupPFNanoAK15_mc  $NO_EXEC $PARALLEL 
...
--customise PhysicsTools/PFNanoAK15/addAK15_cff.setupPFNanoAK15_data  $NO_EXEC $PARALLEL
