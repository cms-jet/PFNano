...
--customise PhysicsTools/AK15Nano/addAK15_cff.PFnano_addAK15_mc  $NO_EXEC $PARALLEL
...
--customise PhysicsTools/AK15Nano/addAK15_cff.PFnano_addAK15_data  $NO_EXEC $PARALLEL
