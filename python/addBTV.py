...
def add_BTV(process, runOnMC=False, onlyAK4=False, onlyAK8=False, keepInputs=['DeepCSV','DDX'], storeAK4Truth='no'):
    ...
    FatJetVars = cms.PSet(
        ...
        DeepCSVBDisc=Var("bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb')",
            ...
            doc="DeepCSVBDisc",
            precision=10),
        #DeepCSVb=Var("bDiscriminator('pfDeepCSVJetTags:probb')",
        #  float,
        #  doc="DeepCSVb",
        #  precision=10),
        btagDeepB_c=Var("bDiscriminator('pfDeepCSVJetTags:probc')",
                        ...
                        precision=10),
        # Jet_DeepCSVcc --> assente!
        # btagDeepB_cc=Var("bDiscriminator('pfDeepCSVJetTags:probcc')",
        #                        float,
        #                        doc="DeepCSV cc tag discriminator",
        #                        precision=10),
        ...
        DeepCSVCvsBDisc=Var("? (bDiscriminator('pfDeepCSVJetTags:probc'))!=-1 ? bDiscriminator('pfDeepCSVJetTags:probc')/(bDiscriminator('pfDeepCSVJetTags:probc')+bDiscriminator('pfDeepCSVJetTags:probb')+bDiscriminator('pfDeepCSVJetTags:probbb')) : -1",
            ...
            precision=10),
        # SV_multi -> da rivedere 
        #SV_multi=Var("svTagInfo->nVertices()",
        #                int,
        #                doc="SV multiplicity",
        #                precision=10),
