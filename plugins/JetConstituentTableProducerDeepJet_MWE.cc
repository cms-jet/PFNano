...
template<typename T>
class JetConstituentTableProducerDeepJet_MWE : public edm::stream::EDProducer<> {
public:
  explicit JetConstituentTableProducerDeepJet_MWE(const edm::ParameterSet &);
  ~JetConstituentTableProducerDeepJet_MWE() override;
...
//
template< typename T>
JetConstituentTableProducerDeepJet_MWE<T>::JetConstituentTableProducerDeepJet_MWE(const edm::ParameterSet &iConfig)
...
template< typename T>
JetConstituentTableProducerDeepJet_MWE<T>::~JetConstituentTableProducerDeepJet_MWE() {}

template< typename T>
void JetConstituentTableProducerDeepJet_MWE<T>::produce(edm::Event &iEvent, const edm::EventSetup &iSetup) {
...
template< typename T>
void JetConstituentTableProducerDeepJet_MWE<T>::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
...
typedef JetConstituentTableProducerDeepJet_MWE<pat::Jet> PatJetConstituentTableProducerDeepJet_MWE;
//typedef JetConstituentTableProducer<reco::GenJet> GenJetConstituentTableProducer;

DEFINE_FWK_MODULE(PatJetConstituentTableProducerDeepJet_MWE);
